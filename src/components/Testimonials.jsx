      ...
      <div className="container relative mx-auto px-4">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-lg text-slate-600">
            Thousands of professionals have improved their resumes, increased
            ATS scores, and secured more interviews.
          </p>
        </div>
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((item) => (
            ...
            >
              ...
              {/* Review */}
              <p className="leading-relaxed text-slate-600">"{item.review}"</p>
        ...
        <div className="mt-16 grid gap-8 text-center md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-2 text-slate-600">Average ATS Score Improvement</p>
          </div>

          <div>
            <h3 className="text-4xl font-bold text-indigo-600">10K+</h3>
            <p className="mt-2 text-slate-600">Successful Job Seekers</p>
          </div>
        </div>
      </div>
    </section>
