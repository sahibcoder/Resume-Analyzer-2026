        ...
        <div className="relative overflow-hidden rounded-[32px] bg-slate-950 px-8 py-20 text-center text-white md:px-16">
          ...
          <div className="relative z-10">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-300">
              ...
              keywords, and increase your chances of getting noticed by
              recruiters.
            </p>
            ...
            <div className="mt-14 grid gap-8 border-t border-slate-800 pt-10 md:grid-cols-3">
              <div>
                ...
                <p className="mt-2 text-slate-400">Resumes Analyzed</p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-slate-400">Successful Job Seekers</p>
              </div>
            </div>
          </div>
        </div>
