...
export default function Hero() {
  return (
    <section className="relative overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 -z-10 bg-linear-to-b from-indigo-50 to-white" />
        ...
        <div className="grid min-h-[90vh] items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg text-muted-foreground">
              Upload your resume and instantly receive ATS scores, missing
              keyword analysis, strengths, weaknesses, and actionable
              recommendations tailored to your target job.
            </p>
          ...
          <div className="relative">
            ...
            <div className="absolute -left-6 top-10 rounded-xl border bg-white px-4 py-3 shadow-lg">
              <p className="text-sm font-medium">+12 Keywords Found</p>
            </div>
            ...
            <div className="absolute -bottom-4 left-8 rounded-xl border bg-white px-4 py-3 shadow-lg">
              <p className="text-sm font-medium">ATS Approved ✓</p>
            </div>
